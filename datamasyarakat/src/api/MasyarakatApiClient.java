...
public class MasyarakatApiClient {
    private static final String BASE_URL = "http://localhost/api/masyarakat.php";
    ...
    public List<Masyarakat> findAll() throws Exception {
        ...
        ApiResponse<List<Masyarakat>> apiResp = gson.fromJson(response.body(),
                new TypeToken<ApiResponse<List<Masyarakat>>>() {
                }.getType());
        if (!apiResp.success)
    ...
    public void create(Masyarakat m) throws Exception {
    ...
    public void update(Masyarakat m) throws Exception {
        var requestBody = new HashMap<String, Object>();
        requestBody.put("noKtp", m.getNoKtp());
        requestBody.put("nama", m.getNama());
        requestBody.put("alamat", m.getAlamat() != null ? m.getAlamat() : null);
