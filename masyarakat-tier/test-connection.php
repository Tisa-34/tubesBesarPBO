...
try {
    ...
    if ($conn) {
        ...
        // Test query
        $stmt = $conn->query("SELECT COUNT(*) as total FROM masyarakat");
        $result = $stmt->fetch(PDO::FETCH_ASSOC);
        echo "✅ Total masyarakat: " . $result['total'] . "<br>";
...
try {
    ...
    require_once 'app/models/Masyarakat.php';
    
    $masyarakat = new Masyarakat($conn);
    $stmt = $masyarakat->getAll();
